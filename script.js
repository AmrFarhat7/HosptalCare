...
document.querySelectorAll('.service-card, .doctor-card, .stat-item, .about-text').forEach(el => {
    el.style.opacity = '0';
...
document.querySelectorAll('.doctor-card button').forEach(btn => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const serviceSelect = document.querySelector('#patientModal select');
    if (serviceSelect) {
